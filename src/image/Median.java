...
public class Median {
    ...
    /**
     * This method is used to perform median filtering on the image object
     * passed.
     *
     * @param img The image object passed on which median filtering is
     * performed.
     * @param maskSize - The size of the mask is an odd integer like 3, 5, 7 …
     * etc.
     */
    public static MyImage medianFilter(MyImage img, int maskSize) {

        /**
         * This array will store the output of the median filter operation which
         * will be later written back to the original image pixels.
         */
        ...
        /**
         * Buff is a 2D square of odd size like 3x3, 5x5, 7x7, ... For
         * simplicity storing it into 1D array.
         */
        int buff[];
    ...
    public static void medianFilter_RGB(MyImage img, int maskSize) {
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                ...
                int p = MyImage.getPixelValueFromARGBValue(a, red[index], green[index], blue[index]);
    ...
    /**
     * This method is used to perform median filtering on the image object
     * passed. This method will fill the cells of the mask not over the pixels
     * of the image with 0.
     *
     * Mask 3x3 | V Image Pixels 3x5 +-+-+-+ | |0|0|0| V +-+-+-+-+-+-+
     * |0|1|2|3|2|1| +-+-+-+-+-+-+ |0|4|5|6|5|4| +-+-+-+-+-+-+ |7|8|9|8|7|
     * +-+-+-+-+-+
     *
     * @param img The image object passed on which median filtering is
     * performed.
     ...
     * This method is used to perform median filtering on the image object
     * passed. This method will fill the cells of the mask not over the pixels
     * of the image with the value of the pixels near to the cell.
     *
     * Mask 3x3 | V Image Pixels 3x5 +-+-+-+ | |1|1|2| V +-+-+-+-+-+-+
     * |1|1|2|3|2|1| +-+-+-+-+-+-+ |4|4|5|6|5|4| +-+-+-+-+-+-+ |7|8|9|8|7|
     * +-+-+-+-+-+
     *
     * @param img The image object passed on which median filtering is
     * performed.
